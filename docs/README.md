...
**Live page:** `docs/index.html` (open it locally, or serve it with GitHub Pages)
...
```bash
git clone git@github.com:RimjhimD/Lofi-Hackathon.git
cd Lofi-Hackathon/docs
xdg-open index.html        # or: python3 -m http.server 8000
```

To publish with GitHub Pages: **Settings → Pages → Source: `main` / `/docs`**.
